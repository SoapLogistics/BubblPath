...
class FractalOntologySynthesizer:
    ...
    def learn_concept(self, concept_name: str, domain: str, vector_override: Vector = None, quantize: bool = True) -> None:
        ...
        with self.lock:
            ...
            if len(self.concepts) > self.max_concepts:
                ...
                for concepts in self.domains.values():
    ...
    def find_nearest_concepts(self, target_vector: Vector, domain_filter: str | None = None, exclude: list[str] | None = None, top_k: int = 5) -> list[tuple[str, float]]:
        """
